...
func (c *Config) Apply(source []byte) ([]byte, error) {
	opts, _ := asposecells.NewXpsSaveOptions()
...
func init() {
	formats.Register("xps", func() SaveOption {
		return New()
	})
}
...
//
// The New function creates an instance of xps SaveOption using the Functional Options Pattern. This function accepts a variable number of Option function parameters, and each Option function moxpsies the configuration of SaveOption.
//
// Parameters:
//
