...
func init() {
	formats.Register("epub", func() saveoptions.SaveOption {
		return New()
	})
}

// New creates a new instance of epub save options
//
// The New function creates an instance of epub SaveOption using the Functional Options Pattern. This function accepts a variable number of Option function parameters, and each Option function modifies the configuration of SaveOption.
//
// Parameters:
//
...
//
// Return value:
// epub SaveOption - Configured instance of the saved option
//
// Usage example:
//
